...
class Mlt2017Text(TextDataset):
    ...
    def parse_txt(gt_path):
        ...
        """
        # print("gt_path is {}".format(gt_path)) # data/MLT2017/mlt_train/gt_img_2777
        # print("gt_path + .txt is {}".format(gt_path + ".txt")) # data/MLT2017/mlt_train/gt_img_2777.txt
    ...
    def __getitem__(self, item):
        ...
        # Read image data
        # image_path = '../data/MLT2017/mlt_train/img_1188.jpg'
        image_path = os.path.join(self.data_root, image_id)
        image = pil_load_img(image_path)
        try:
            h, w, c = image.shape
            # print(f"h,w,c is {h},{w},{c}")
            assert (c == 3)
        except:
        ...
        return self.get_training_data(image, polygons, image_id=image_id.split("/")[-1], image_path=image_path, ratio=cfg.ratio)
