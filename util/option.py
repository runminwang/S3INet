...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--mgpu', default=False, type=str2bool, help='Use multi-gpu to train model')
        ...
        self.parser.add_argument('--vis_dir', default='./vis_selftrain_merge/', help='Path to save visualization images')
        ...
        # 相关消融实验数据
        self.parser.add_argument('--ratio', default=1.0, type=float, help='whether to shrunk')
        self.parser.add_argument('--beta', default=0., type=float, help='aux_seg loss')
